...
<div class="page-content">
   <div class="page-bar">
      <div class="page-title-breadcrumb">
         <div class=" pull-left">
            <div class="page-title">All Bed</div>
         </div>
         <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                  href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li><a class="parent-item" href="#"> Bed</a>&nbsp;<i
                  class="fa fa-angle-right"></i>
            </li>
            <li class="active"> All Bed</li>
         </ol>
      </div>
   </div>
   <div class="row">
                           ...
                           <div class="card-body ">
                              <div class="row">
                                 <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="btn-group">
                                       <a href="{{route('add.bed')}}" id="addRow"
                                          class="btn btn-info">
                                 ...
                                 <table
                                    ...
                                    <tbody>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td>{{$row->price}}</td>
                                          <td>
                                             <a href="{{url('bed/edit/'.$row->id)}}"
                                                   class="btn btn-primary btn-xs">
                                                   <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="{{url('bed/delete/'.$row->id)}}"
                           ...
                           <div class="card-body no-padding ">
                              <div class="doctor-profile">
                                 <div class="profile-usertitle">
                                    <div class="doctor-name">{{$row->catname}} </div>
