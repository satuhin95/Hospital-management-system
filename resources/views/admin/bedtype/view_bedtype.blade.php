...
<div class="page-content">
   <div class="page-bar">
      <div class="page-title-breadcrumb">
         <div class=" pull-left">
            <div class="page-title">All Bedtype</div>
         </div>
         <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                  href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li><a class="parent-item" href="#"> Bedtype</a>&nbsp;<i
                  class="fa fa-angle-right"></i>
            </li>
            <li class="active"> All Bedtype</li>
         </ol>
      </div>
   </div>
   <div class="row">
                           ...
                           <div class="card-body ">
                              <div class="row">
                                 <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="btn-group">
                                       <a href="{{route('add.bedtype')}}" id="addRow"
                                          class="btn btn-info">
                                 ...
                                 <table
                                    ...
                                    <tbody>
                                       ...
                                       <tr class="odd gradeX">
                                          ...
                                          <td>{{$row->name}}</td>
                                          <td>
                                             <a href="{{url('bedtype/edit/'.$row->id)}}"
                                                   class="btn btn-primary btn-xs">
                                                   <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="{{url('bedtype/delete/'.$row->id)}}"
