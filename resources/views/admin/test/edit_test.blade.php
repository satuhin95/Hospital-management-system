...
<div class="page-content">
   <div class="page-bar">
      <div class="page-title-breadcrumb">
         <div class=" pull-left">
            <div class="page-title">Update Test</div>
         </div>
      ...
      <div class="col-md-12 col-sm-12">
         <div class="card card-box">
            ...
            <div class="card-body" id="bar-parent">
               <form action="{{URL::to('test/update/'.$data->id)}}" id="form_sample_1" class="form-horizontal" method="POST">
                  @csrf
                  <div class="form-body">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-5">
                        <input type="text" name="price" data-required="1" value="{{$data->price}}"
                              class="form-control input-height" />
                        </div>
                     </div>
