...
<div class="page-content">
   <div class="page-bar">
      <div class="page-title-breadcrumb">
         <div class=" pull-left">
            <div class="page-title">Update Ward</div>
         </div>
         <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Update Ward</li>
         </ol>
      </div>
   </div>
   <div class="row">
      <div class="col-md-12 col-sm-12">
         <div class="card card-box">
            ...
            <div class="card-body" id="bar-parent">
               <form action="{{URL::to('ward/update/'.$data->id)}}" id="form_sample_1" class="form-horizontal" method="POST">
                  @csrf
                  <div class="form-body">
